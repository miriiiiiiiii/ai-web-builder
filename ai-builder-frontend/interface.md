...
| 参数名称 | 参数说明 | 请求类型    | 是否必须 | 数据类型 | schema |
| -------- | -------- | ----- | -------- | -------- | ------ |
|emailLoginRequest|EmailLoginRequest|body|true|EmailLoginRequest|EmailLoginRequest|
|&emsp;&emsp;userEmail|||false|string||
...
| 参数名称 | 参数说明 | 请求类型    | 是否必须 | 数据类型 | schema |
| -------- | -------- | ----- | -------- | -------- | ------ |
|accountLoginRequest|AccountLoginRequest|body|true|AccountLoginRequest|AccountLoginRequest|
|&emsp;&emsp;userAccount|||false|string||
|&emsp;&emsp;userPassword|||false|string||
