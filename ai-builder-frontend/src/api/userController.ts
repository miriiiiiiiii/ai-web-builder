...
/** 此处后端没有提供注释 POST /user/account/login */
export async function loginByAccount(
  body: API.AccountLoginRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseLoginUserVO>('/user/account/login', {
    method: 'POST',
    headers: {
...
/** 此处后端没有提供注释 POST /user/email/code */
export async function sendEmailCode(body: API.EmailLoginRequest, options?: { [key: string]: any }) {
...
export async function loginByEmail(body: API.EmailLoginRequest, options?: { [key: string]: any }) {
